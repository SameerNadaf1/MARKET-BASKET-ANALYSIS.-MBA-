...
<jsp:include page="menus.jsp"></jsp:include>
   ...
   <jsp:include page="side_menu.jsp"></jsp:include>
    ...
    <div class="header">
            ...
            <h1 class="page-title">Customer Bill Add </h1>
    </div>
...
<form name="form1" method="post" action="billdetails_insert.jsp" id="formID">
<table class="table table-striped">
    ...
    <tr>
      ...
      <td width="144"><select name="bill_master_id" id="bill_master_id" class="validate[required]">
...
while(rs.next())
{
int id=rs.getInt("bill_master_id");
%>
...
%>
    ...
    <tr>
      <td>Product id </td>
      <td><select name="pro_id" id="pro_id" class="validate[required]">
        <option value="">select</option>
		<%
ResultSet rs1=s.stmt.executeQuery("select * from products");
while(rs1.next())
{
int id=rs1.getInt("pro_id");
%>
<option value="<%=id%>"><%=rs1.getString("pro_name")%></option> 
<%
}
%>
      </select></td>
